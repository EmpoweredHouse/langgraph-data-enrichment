...
ANALYST_INSTRUCTIONS_PROMPT = """You are tasked with creating a set of AI analyst personas. Follow these instructions carefully:
...
QUESTION_INSTRUCTIONS_PROMPT = """You are an analyst tasked with interviewing an expert to learn about a specific topic. 
...
INTRO_CONCLUSTION_INSTRUCTIONS_PROMPT = """You are a technical writer finishing a report on {topic}
